...
In this section we will take a shallow dive into the syntax as well as the semantics of the TypeScript type system. This will prepare you for a deeper dive later.
