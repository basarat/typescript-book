* [lib.d.ts](#libdts)
* [lib.d.ts 뜯어보기](#libdts-뜯어보기)
* [Native 타입 수정](#native-타입-수정)
* [커스텀 `lib.d.ts` 사용](#커스텀-libdts-사용)
* [Compiler target이 `lib.d.ts`에 끼치는 영향](#compiler-target이-libdts에-끼치는-영향)
* [`lib` 옵션](#lib-옵션)
* [구 JavaScript 엔진 Polyfill](#구-javascript-엔진-polyfill)
...
### Compiler target이 `lib.d.ts`에 끼치는 영향
